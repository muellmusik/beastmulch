...
BMSpatialGranulator {
	...
	*new { arg speakerList, space, buffer, target = nil, addAction = \addToHead;
		^super.new.init(speakerList, space, buffer, target, addAction);
	}
...
//	}
	...
	*initClass {
	...
	init { arg argspeakerList, argspace, argbuffer, target, addAction;
...
//		outFunc = Routine({
//			loop({
//				kdTree.nearest(space.next.pos)[0].label.yield;
//			})
//		});
		outFunc = space.outFunc; 
